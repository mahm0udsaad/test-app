...
const Home = () => {
    ...
    const { PopUp: HistoryPopup } = usePopup({ path: 'History' ,icon:faHistory  ,color:'red'});

  return (
    <div
      className="main font-Font2 h-screen flex flex-col justify-center items-center"
    >
      <h1 className="animate-charcter lg:text-4xl text-2xl  mb-5 text-center text-white font-semibold ">Welcome to the Test App</h1>
